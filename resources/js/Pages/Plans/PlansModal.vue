...
<template>
    <div class="modal modal-lg fade" id="create-plan" tabindex="-1" aria-labelledby="bankModalLabel"
        aria-hidden="false">
                        ...
                        <div class="row">
                            <form @submit="submit">
                                <div class="form-group">
                                    ...
                                    <input class="form-control h_50" @focus="onInputFocus('title')" id="title" required
                                ...
                                <div class="form-group mt-1">
                                    ...
                                    <div class="loc-group position-relative">
                                        ...
                                        <Editor api-key="9l6lug40mtg10elrk1ncpkmwgmd9gmu8xggx0h2i8ad8xt82" :init="{
                                        ...
                                        }" initial-value="" v-model="form.description" />
                                        <div class="text-danger" v-if="errors.description">{{ errors.description }}
                                        </div>
                                    </div>
                                </div>
