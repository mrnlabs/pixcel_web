                ...
                <div class="container">
                    ...
                    >
                        ...
                        <div class="offcanvas-body">
                            ...
                            <ul
                                class="navbar-nav justify-content-end flex-grow-1 pe_5"
                            >
                                <li class="nav-item">
                                    <a
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu">
                                        ...
                                        <li>
                                            <a
                                                class="dropdown-item"
                                                href="attendee_profile_view.html"
                                                >Attendee Profile View</a
                                            >
                                        </li>
                                        <li>
                                            <a
